/*********************************
 ...
 File:       adstats.component.js
 Function:   Shows stats about an advert
 Copyright:  Overplay TV
 Date:       5/3/17 12:08 PM
 Author:     mkahn
...
app.component( 'adStats', {
    ...
    template: `
        <div>
        <h4>Not Ported Yet</h4>
        <p>Stats for {{ $ctrl.advert.name }} will be here soon!</p>
        </div>
    `

});

// Original HTML below for reference...
